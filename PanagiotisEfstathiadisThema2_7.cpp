...
//aristera xeri opote to deksi tou
glBegin(GL_POLYGON);
glVertex3f(236.0-20+roloi/2000, 234-roloi/1700, 1);
glVertex3f(255.0-20+roloi/20000, 280-roloi/1700, 1);
glVertex3f(307.0-20+roloi/6000, 299-roloi/5000, 1);
glVertex3f(285.0-20+roloi/6000, 270-roloi/5000, 1);
glVertex3f(252.0-20+roloi/20000, 254-roloi/1700, 1);
glVertex3f(245.0-20+roloi/2000, 232-roloi/1700, 1);
glEnd();

//PALAMI
glColor3f(223.0/255.0,181.0/255.0,112.0/255.0);
glBegin(GL_POLYGON);
glVertex3f(248.0-30+roloi/2000, 242-10-roloi/1700, 1);
glVertex3f(251.0-30+roloi/2000, 238-10-roloi/1700, 1);
glVertex3f(250.0-30+roloi/2000, 228-10-roloi/1700, 1);
glVertex3f(248.0-30+roloi/2000, 222-10-roloi/1700, 1);
glVertex3f(246.0-30+roloi/2000, 219-10-roloi/1700, 1);
glVertex3f(241.0-30+roloi/2000, 221-10-roloi/1700, 1);
glVertex3f(238.0-30+roloi/2000, 226-10-roloi/1700, 1);
glVertex3f(240.0-30+roloi/2000, 236-10-roloi/1700, 1);
glVertex3f(243.0-30+roloi/2000, 241-10-roloi/1700, 1);
glEnd();
...
glColor3f(207.0/255.153,122.0/255.0,83.0/255.0);
glBegin(GL_POLYGON);
glVertex3f(245.0+roloi/2500, 203-roloi/5000, 1);
glVertex3f(238.0+roloi/2500, 186-roloi/5000, 1);
glVertex3f(201.0+roloi/2500, 195-roloi/5000, 1);
glVertex3f(201.0+roloi/2500, 201-roloi/5000, 1);
glVertex3f(207.0+roloi/2500, 218-roloi/5000, 1);
glVertex3f(239.0+roloi/2500, 209-roloi/5000, 1);
glEnd();
//GRAMMES GIA TO touvlo
glColor3f(2.0/255.0,2.0/255.0,2.0/255.0);
glBegin(GL_LINES);
glVertex2f(208.0+roloi/2500, 219-roloi/5000);
glVertex2f(199.0+roloi/2500, 200-roloi/5000);
glVertex2f(200.0+roloi/2500, 199-roloi/5000);
glVertex2f(232.0+roloi/2500, 189-roloi/5000);
glVertex2f(232.0+roloi/2500, 189-roloi/5000);
glVertex2f(237.0+roloi/2500, 185-roloi/5000);
glVertex2f(237.0+roloi/2500, 185-roloi/5000);
glVertex2f(246.0+roloi/2500, 202-roloi/5000);
glVertex2f(246.0+roloi/2500, 202-roloi/5000);
glVertex2f(239.0+roloi/2500, 210-roloi/5000);
glVertex2f(239.0+roloi/2500, 210-roloi/5000);
glVertex2f(232.0+roloi/2500, 191-roloi/5000);
glVertex2f(199.0+roloi/2500, 199-roloi/5000);
glVertex2f(204.0+roloi/2500, 193-roloi/5000);
glVertex2f(204.0+roloi/2500, 193-roloi/5000);
glVertex2f(236.0+roloi/2500, 184-roloi/5000);
glVertex2f(240.0+roloi/2500, 209-roloi/5000);
glVertex2f(208.0+roloi/2500, 219-roloi/5000);
glEnd();
